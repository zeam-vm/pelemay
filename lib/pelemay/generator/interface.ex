defmodule Pelemay.Generator.Interface do
  ...
  def generate(module) do
    ...
    defmodule PelemayNif#{module} do
      @compile {:autoload, false}
      @on_load :load_nifs

      def load_nifs do
        :erlang.load_nif(Application.app_dir(:pelemay, "priv/libnif#{String.downcase(module |> Atom.to_string() |> String.replace(".", ""))}"), 0)
      end
    ...
    Application.app_dir(:pelemay, "priv/pelemay_nif_#{String.downcase(Atom.to_string(module))}.ex")
    |> File.write(str)
